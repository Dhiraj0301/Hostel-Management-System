...
<body>
	<div class="header">
        ...
        <div class="header-anchor">
            ...
            <div class="menu"><a href="mennu.jsp"><i class="ri-restaurant-fill"></i></a></div>
    ...
    <div class="card">
        ...
        <div class="ticket-container">
            <img src="asset/sweeper.jpg" alt="" class="svg-image">
            <h3>Sweeper Needed</h3>
        ...
        <div class="submit-service">
        	<form action="<%= request.getContextPath() %>/SubmitRequestServlet" method="post">
   			 <input type="hidden" name="serviceType" value="Sweeper"> <!-- Example: Electrician -->
